...
mkdir -p $KUNGFU_JOURNAL_DIR/MD/TORA
mkdir -p $KUNGFU_JOURNAL_DIR/MD_RAW/TORA
mkdir -p $KUNGFU_JOURNAL_DIR/TD/TORA
mkdir -p $KUNGFU_JOURNAL_DIR/TD_RAW/TORA
mkdir -p $KUNGFU_JOURNAL_DIR/TD_SEND/TORA
mkdir -p $KUNGFU_JOURNAL_DIR/TD_Q/TORA
