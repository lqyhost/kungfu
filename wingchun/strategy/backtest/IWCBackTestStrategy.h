...
#ifndef WINGCHUN_IWCBackTestStrategy_H
#define WINGCHUN_IWCBackTestStrategy_H
...
class IWCBackTestStrategy: public IWCBackTestDataProcessor
{
protected:
    bool td_is_ready(short source) const;
    bool td_is_connected(short source) const;
public:
    /** IWCBackTestDataProcessor functions *//* market data */
...
public:
    /** default destructor */
    virtual ~IWCBackTestStrategy();
    /** default constructor */
    IWCBackTestStrategy(const string& name);
    /* start data thread */
    virtual void start();
