...
#ifndef WINGCHUN_PyBackTestWCStrategy_H
#define WINGCHUN_PyBackTestWCStrategy_H

#include "IWCBackTestStrategy.h"

WC_NAMESPACE_START

class PyBackTestWCStrategy: public IWCBackTestStrategy
{
private:
...
public:
    PyBackTestWCStrategy(const string& name): IWCStrategy(name) {}
    PyBackTestWCStrategy(): IWCStrategy("Default") {}
};

DECLARE_PTR(PyBackTestWCStrategy);

WC_NAMESPACE_END

#endif //WINGCHUN_PyBackTestWCStrategy_H
