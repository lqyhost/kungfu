...
#include "PyWCBackTestStrategy.h"
...
void PyBackTestWCStrategy::init()
{
...
void PyBackTestWCStrategy::start()
{
    Py_Initialize();
...
void PyBackTestWCStrategy::on_market_data(const LFMarketDataField* data, short source, long rcv_time)
{
...
void PyBackTestWCStrategy::on_market_bar(const BarMdMap& data, int min_interval, short source, long rcv_time)
{
...
void PyBackTestWCStrategy::on_rtn_order(const LFRtnOrderField* data, int request_id, short source, long rcv_time)
{
...
void PyBackTestWCStrategy::on_rtn_trade(const LFRtnTradeField* data, int request_id, short source, long rcv_time)
{
...
void PyBackTestWCStrategy::on_rsp_order(const LFInputOrderField* data, int request_id, short source, long rcv_time, short errorId, const char* errorMsg)
{
    if (errorId != 0)
    {
...
void PyBackTestWCStrategy::on_rsp_position(const PosHandlerPtr posMap, int request_id, short source, long rcv_time)
{
...
void PyBackTestWCStrategy::on_switch_day(long rcv_time)
{
...
boost::python::list PyBackTestWCStrategy::get_effective_orders() const
{
    return kungfu::yijinjing::std_vector_to_py_list<int>(data->get_effective_orders());
}

void PyBackTestWCStrategy::set_init(bp::object func)
{
    py_init = func;
}

void PyBackTestWCStrategy::set_on_data(short msg_type, bp::object func)
{
    py_on_data[msg_type] = func;
}

void PyBackTestWCStrategy::set_on_pos(bp::object func)
{
    py_on_pos = func;
}

void PyBackTestWCStrategy::set_on_error(bp::object func)
{
    py_on_error = func;
}

void PyBackTestWCStrategy::set_on_switch_day(bp::object func)
{
...
BOOST_PYTHON_MODULE(libwingchunstrategy)
{
    ...
    bp::class_<PyBackTestWCStrategy, PyBackTestWCStrategyPtr>("Strategy")
    .def(bp::init<string>(bp::arg("name")))
    .def("get_strategy_util", &PyBackTestWCStrategy::get_strategy_util)
    .def("get_data_wrapper", &PyBackTestWCStrategy::get_data_wrapper)
    .def("get_name", &IWCStrategy::get_name)
    .def("get_effective_orders", &PyBackTestWCStrategy::get_effective_orders)
    .def("log_debug", &PyBackTestWCStrategy::log_debug, (bp::arg("msg")))
    .def("log_info", &PyBackTestWCStrategy::log_info, (bp::arg("msg")))
    .def("log_error", &PyBackTestWCStrategy::log_error, (bp::arg("msg")))
    .def("log_fatal", &PyBackTestWCStrategy::log_fatal, (bp::arg("msg")))
    .def("init", &PyBackTestWCStrategy::init)
    .def("run", &PyBackTestWCStrategy::run)
    .def("start", &PyBackTestWCStrategy::start)
    .def("block", &PyBackTestWCStrategy::block)
    .def("set_init", &PyBackTestWCStrategy::set_init, (bp::arg("func")))
    .def("set_on_data", &PyBackTestWCStrategy::set_on_data, (bp::arg("msg_type"), bp::arg("func")))
    .def("set_on_pos", &PyBackTestWCStrategy::set_on_pos, (bp::arg("func")))
    .def("set_on_switch_day", &PyBackTestWCStrategy::set_on_switch_day, (bp::arg("func")))
    .def("insert_market_order", &PyBackTestWCStrategy::insert_market_order_py, (bp::arg("source"), bp::arg("ticker"), bp::arg("exchange_id"), bp::arg("volume"), bp::arg("direction"), bp::arg("offset")))
    .def("insert_limit_order", &PyBackTestWCStrategy::insert_limit_order_py, (bp::arg("source"), bp::arg("ticker"), bp::arg("exchange_id"), bp::arg("price"), bp::arg("volume"), bp::arg("direction"), bp::arg("offset")))
    .def("insert_fok_order", &PyBackTestWCStrategy::insert_fok_order_py, (bp::arg("source"), bp::arg("ticker"), bp::arg("exchange_id"), bp::arg("price"), bp::arg("volume"), bp::arg("direction"), bp::arg("offset")))
    .def("insert_fak_order", &PyBackTestWCStrategy::insert_fak_order_py, (bp::arg("source"), bp::arg("ticker"), bp::arg("exchange_id"), bp::arg("price"), bp::arg("volume"), bp::arg("direction"), bp::arg("offset")))
    .def("req_position", &PyBackTestWCStrategy::req_position, (bp::arg("source")))
    .def("cancel_order", &PyBackTestWCStrategy::cancel_order, (bp::arg("source"), bp::arg("order_id")))
    .def("set_on_error", &PyBackTestWCStrategy::set_on_error, (bp::arg("func")));
